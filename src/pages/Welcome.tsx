...
import { Heart, Stethoscope, Users, ShieldCheck, Activity, Bell, Compass } from "lucide-react";
        ...
        <div className="text-center space-y-6 max-w-3xl mx-auto">
          ...
          <div className="flex justify-center mb-6">
            <div className="w-24 h-24 md:w-32 md:h-32 rounded-[2.5rem] gradient-healing flex items-center justify-center shadow-2xl shadow-primary/20 rotate-3 animate-in zoom-in duration-700">
              <Compass className="h-12 w-12 md:h-16 md:w-16 text-white animate-pulse" />
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center px-6 pt-4">
            ...
            <Button
              className="h-14 px-8 rounded-2xl text-lg font-bold shadow-xl shadow-secondary/20 bg-secondary text-white border-0 flex-1 sm:flex-none transition-all duration-300 hover:scale-105 active:scale-95 hover:bg-gradient-to-r hover:from-secondary hover:to-primary"
