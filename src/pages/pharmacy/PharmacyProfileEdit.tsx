  ...
  const handleSaveProfile = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (profileImage) {
        ...
        const filePath = `pharmacy-profiles/${fileName}`
      ...
      setTimeout(() => navigate("/pharmacy/profile"), 1500)
    } catch (error: any) {
      ...
      <div className="container max-w-2xl mx-auto px-4 py-6">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">حدّث معلومات صيدليتك</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSaveProfile} className="space-y-6">
          ...
          <Card className="rounded-2xl border-primary/5">
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                <Label htmlFor="specializations">التخصصات</Label>
                <Input
                  id="specializations"
          ...
          <Card className="rounded-2xl border-primary/5">
            <CardHeader>
              <CardTitle>نبذة عن الصيدلية</CardTitle>
            </CardHeader>
            <CardContent>
              <Textarea
                name="bio"
                value={formData.bio}
                onChange={handleInputChange}
                placeholder="اكتب نبذة عن صيدليتك وخدماتك"
                rows={5}
              />
            </CardContent>
          </Card>
