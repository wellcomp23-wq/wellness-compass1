...
import MedicalFileSharing from "./pages/MedicalFileSharing";
...
const AppContent = () => {
  return (
    <Routes>
      ...
      <Route path="/medical-file-sharing" element={<ProtectedRoute><MedicalFileSharing /></ProtectedRoute>} />
